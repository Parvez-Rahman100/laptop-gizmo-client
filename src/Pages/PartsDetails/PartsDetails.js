...
const PartsDetails = () => {
    ...
    return (
        <div className='flex justify-evenly sm:flex-auto '>
  ...
  <div className='flex justify-between items-center '>
    ...
    <p>{description}</p>
        ...
        <div className=' mt-10 ' >
        <form className=' px-20 py-5 drop-shadow-2xl shadow-2xl bg-transparent rounded-xl bg-form' onSubmit={handleSubmit}>
